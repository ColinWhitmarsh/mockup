...
class Dashboard extends React.Component {
  ...
  componentDidMount () {
    ...
    d3.selectAll("input").on("change", this.change);

    timeout = setTimeout(function() {
      d3.select("input[value=\"grouped\"]").property("checked", true).each(this.change);
    }, 2000);
  }
  ...
  change() {
    ...
    if (this.state.grouped === true) this.transitionGrouped();
    else this.transitionStacked();
  }
